...
namespace myFood_WebApp.Data.Cart
{
    public class ShoppingCart
    {
        ...
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Food.Id == food.Id
        ...
        public List<ShoppingCartItem> GetShoppingCartItems()
        {
            ...
            ShoppingCartId).Include(n => n.Food).ToList());
        }
